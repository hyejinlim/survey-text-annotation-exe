...
import {
  ...
  fetchInterviewI1List,
  fetchInterviewI2List,
  fetchInterviewIFList,
...
import InterviewDataSelectFilter from '../InterviewDataSelectFilter';

type Props = {
  initData: any;
};

function InterviewInspectionDataList({ initData }: Props) {
  ...
  const fetched = (params: any) => {
    switch (type) {
      case 'I1':
        return fetchInterviewI1List(params);
      case 'I2':
        return fetchInterviewI2List(params);
      case 'F':
        return fetchInterviewIFList(params);
    }
  };
...
export default memo(InterviewInspectionDataList);
