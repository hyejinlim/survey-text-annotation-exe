...
import InterviewLabelingModal from '~/components/annotation/interview/InterviewLabelingModal';
import InterviewQuestionInfoButtons from '~/components/annotation/interview/InterviewQuestionInfoModify/InterviewQuestionInfoButtons';
...
function InterviewInspectionQuestionModify({ dataRefetch, type }: Props) {
  const {
    document,
    setSelectedItem,
    setSelectedText,
  ...
  const { labelingList, info, labelChange, labelingPage } = document;
...
export default memo(InterviewInspectionQuestionModify);
